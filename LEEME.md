...
Los mercados financieros actuales están dominados por algoritmos institucionales que controlan la mayoría del volumen de transacciones (Brogaard et al., 2022):
...
#### Casos Documentados (Arnoldi, 2016; Chen et al., 2024)
...
La investigación en psicología del trading confirma (Kahneman & Tversky, 1979; Hilton, 2001):
...
Los profesionales utilizan ATR para determinar stops que respeten la volatilidad natural (Ahmad et al., 2023):
...
- **Resistencia técnica**: Niveles psicológicos importantes para algoritmos (Osler, 2000)
- **Gestión de riesgo**: Los fondos reducen exposición en máximos históricos

#### Confluencia de Factores
- **Análisis técnico**: Resistencias en máximos previos (Tsinaslanidis & Zapranis, 2016)
...
**Los institucionales que mueven los mercados operan en esta escala temporal**, no en gráficos de minutos (Boehmer et al., 2021). La evolución hacia perspectiva macro representa la diferencia entre:
...
- **Paciencia**: Los movimientos estructurales toman tiempo (Hilton, 2001)
